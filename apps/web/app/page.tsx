...
export default function AssessmentLanding() {
  ...
  return <main><Nav /><section className="landing-hero"><div><p className="eyebrow">EMISSIONLENS · LAYER 1 ASSESSMENT</p><h1>Welcome to your emissions assessment</h1><p className="hero-copy">Review your company profile first, then move through process mapping, source identification, activity data and your final emissions profile.</p></div><div className="hero-badge"><span>●</span><small>Assessment workspace</small><strong>{assessment?.status || "Loading"}</strong></div></section>
