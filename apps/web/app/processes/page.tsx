...
export default function ProcessesPage() {
  ...
  return <main><Nav /><div className="topbar"><div><p className="eyebrow">STEP 3 · PROCESS MAPPING</p><h1>Your process map</h1><p>Review the industry suggestions and the equipment attached to each step. This is the factual context used by source identification.</p></div><Link className="secondary-link" href="/template">← Starter map</Link></div>
